...
Western_Europe %>% 
  ...
  geom_line() +
  theme_light() +
  labs(y="Homicides per 100k peaople" , title = "Historical Homicides") +
...
ggsave("Homicides.png", width = 15, height = 8, dpi = 200)
...
```{r Kings plot ,eval = TRUE}
# Loading and plotting the kings data
